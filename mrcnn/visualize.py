    ...
    for i in range(N):
        ...
        if show_mask:
            if class_id == 1: 
                ...
                masked_image = apply_mask(masked_image, mask, [0, 1, 0])
            elif class_id == 3:
                masked_image = apply_mask(masked_image, mask, [0, 0, 1])
            elif class_id == 4:
                masked_image = apply_mask(masked_image, mask, [0.5, 0.5, 0.5])
            elif class_id == 5:
                masked_image = apply_mask(masked_image, mask, [1, 1, 1])
            else:
                masked_image = apply_mask(masked_image, mask, [0.25, 0.25, 1])
        '''           
